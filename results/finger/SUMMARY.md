...
- Finger truth on keyboard (grid-consistent key/fingertip solution, 3,185 keystrokes): the user touch-types — 94.1% of keystrokes use the touch-typing finger; least consistent keys l (0.51), u (0.76), k (0.78), b (0.80).
